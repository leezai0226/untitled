...
const tabs: TabData[] = [
    ...
    curriculum: [
      ...
      },
      {
        ...
        items: [
          ...
          "컷 편집의 리듬: 본 영상 위에 B-Roll 자연스럽게 얹기(인서트 편집)",
  ...
  },
  {
    ...
    curriculum: [
      ...
      {
        period: "2교시",
        title: "이탈률 줄이기 위한 타이트한 컷 편집",
        duration: "2시간 30분",
        items: [
          "모바일 최적화: 9:16 세팅 및 파일 불러오기",
          "숨 막히는 속도감: AI(또는 단축키)를 활용해 버벅거린 부분과 숨소리 도려내기",
          "시각적 후킹 요소: 중간중간 사업장/제품 사진이나 영상을 덮어씌워(B-Roll) 시선을 붙잡는 실전 스킬",
      ...
      },
      {
        ...
        items: [
          ...
          "제공된 프리셋 완벽 마스터: '고퀄리티 모션 프리셋'과 '자막 스타일'을 내 영상에 직접 적용, 내 브랜드 톤앤매너에 맞게 수정하여 '나만의 템플릿'으로 저장하는 워크플로우 실습",
        ],
      },
      {
        period: "4교시",
